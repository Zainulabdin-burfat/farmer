<?php 
	...
	class DbConnection extends db_drivers {
		...
		public function _register($first_name,$last_name,$email,$password,$img,$city_id,$exp_lvl,$phone,$add,$time){

			$q = "INSERT INTO user(first_name,last_name,user_email,user_password,user_image,city_id,expert_level,phone_number,address,added_on)
					VALUES('$first_name','$last_name','$email','$password','$img','$city_id','$exp_lvl','$phone','$add','$time')";
