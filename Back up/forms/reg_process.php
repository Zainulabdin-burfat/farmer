<?php
	...
	if (isset($_POST['register'])) {
		...
		if (move_uploaded_file($_FILES['picture']['tmp_name'],"../images/".$_FILES['picture']['name'])) {
			...
			$db->_register($_POST['first_name'],$_POST['last_name'],$_POST['email'],hash("md5",$_POST['password']),"images/".$_FILES['picture']['name'],$_POST['city'],$_POST['expert'],$_POST['number'],$_POST['address'],time());
			if ($db->result) {
